...
#   end
# User.delete_all()
User.create(name:"顾翔",phone:"15005273928",phone_short:"673928",password:'l',password_confirmation:'l')
User.create(name:"黄敏",phone:"15062886274",phone_short:"662748",password:'l',password_confirmation:'l')
User.create(name:"王奇雅",phone:"13951048940",phone_short:"648940",password:'l',password_confirmation:'l')
