...
class FixedAssetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fixed_asset" do
    assert_difference('FixedAsset.count') do
      post fixed_assets_url, params: { fixed_asset: { number: @fixed_asset.number, serial: @fixed_asset.serial } }
    end
  ...
  test "should update fixed_asset" do
    patch fixed_asset_url(@fixed_asset), params: { fixed_asset: { number: @fixed_asset.number, serial: @fixed_asset.serial } }
